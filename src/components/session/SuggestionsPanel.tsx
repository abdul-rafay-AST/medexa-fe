...
export function SuggestionsPanel({
  ...
  return (
    <Card className="p-4 md:p-6 rounded-3xl bg-white shadow-sm border-medexa-gray-100 flex flex-col min-h-0 flex-[2]">
      ...
      <Tabs defaultValue="billing" className="flex flex-col flex-1 min-h-0">
        <TabsList className="w-full grid grid-cols-2 bg-medexa-gray-50 p-1 rounded-full mb-4 shrink-0">
        ...
        <TabsContent
          value="billing"
          className="flex-1 min-h-0 overflow-y-auto pr-2 scrollbar-thin scrollbar-thumb-medexa-gray-200 outline-none mt-0 data-[state=inactive]:hidden"
        >
